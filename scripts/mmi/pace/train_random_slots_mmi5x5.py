...
def task_launcher(args):
    ...
    device_list = ["slot_mmi5x5"]
    data_list = [f"slot_mmi5x5_rHz_{i}_fields_epsilon_normalize_0_grid_0.05um"  for i in range(n_data)]
    grid_step = 0.05
    ...
    aug_path = False
    # skip connection: use the same skip connection as in factorized ffno to enable deep layers
    layer_skip = True
    block_skip = True
